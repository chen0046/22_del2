public class Printregler {
    public void Spilleregler() {
        ...
        System.out.println("11 felter, mellem 2 og 12");
        System.out.println();
        ...
        System.out.println("3) Antalet af terningeøjne afgøre hvilket felt spilleren lander på");
        System.out.println("4) Hvet felt indeholder en værdig (positiv eller negativ), som bliver tilføjet til spilleres pengebeholdning");
